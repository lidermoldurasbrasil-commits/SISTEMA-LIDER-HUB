...
import { Calendar as CalendarIcon, ChevronLeft, ChevronRight, Plus, X, CheckCircle, Clock, AlertCircle, List, CheckSquare, MessageSquare, Paperclip, MapPin, User } from 'lucide-react';
                ...
                <form onSubmit={handleSalvarTarefa} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Ex: Sala de Reuniões, Online (Zoom), etc."
                      className="w-full border border-gray-300 rounded-lg px-3 py-2"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-3">
                        <div className="flex items-center gap-2">
                          {membroSelecionado?.foto_url ? (
                            <img src={membroSelecionado.foto_url} alt={membroSelecionado.nome} className="w-8 h-8 rounded-full" />
                          ) : (
                            <div className="w-8 h-8 rounded-full bg-indigo-500 flex items-center justify-center text-white font-bold text-sm">
                              {membroSelecionado?.nome?.substring(0, 2).toUpperCase()}
                            </div>
                          )}
                          <div>
                            <div className="font-medium text-gray-900">{membroSelecionado?.nome}</div>
                            <div className="text-xs text-gray-600">Responsável Principal</div>
                          </div>
                        </div>
                      </div>
                      <div className="text-sm text-gray-500">
                        💡 Para adicionar mais participantes, use as tags abaixo
                      </div>
                    </div>
                  </div>
